...
```bash
npm i @tailwindcss/typography autoprefixer next postcss react react-dom tailwindcss @tailwindcss/forms && npm i -D @testing-library/jest-dom @testing-library/react @types/jest @types/node @types/react babel-jest eslint eslint-config-next eslint-config-prettier eslint-plugin-jest-dom eslint-plugin-prettier eslint-plugin-tailwind eslint-plugin-unused-imports identity-obj-proxy jest prettier react-test-renderer typescript
# or
yarn add @tailwindcss/typography autoprefixer next postcss react react-dom tailwindcss @tailwindcss/forms && yarn add @testing-library/jest-dom @testing-library/react @types/jest @types/node @types/react babel-jest eslint eslint-config-next eslint-config-prettier eslint-plugin-jest-dom eslint-plugin-prettier eslint-plugin-tailwind eslint-plugin-unused-imports identity-obj-proxy jest prettier react-test-renderer typescript -D
...
<article class="prose lg:prose-xl">
  ...
  <p>
    Configuring Next.js with TypeScript, ESLint & prettier can become really annoying, especially if you're a beginner
    and don't know the intricate details of all the moving parts in a web-dev environment. The most important things you
    have to set up are:
  </p>
  <ul>
